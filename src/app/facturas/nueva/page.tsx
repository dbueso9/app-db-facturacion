...
import { getClientes, getServicios, crearNumeroFactura, saveFactura, getSiguienteSecuencia } from "@/lib/store";
...
export default function NuevaFacturaPage() {
  ...
  useEffect(() => {
    ...
    const siguiente = getSiguienteSecuencia();
    setLimiteAlcanzado(siguiente > EMPRESA.secuenciaFin);
  }, []);
  ...
  function onSubmit(data: FormValues) {
    ...
    const { secuencia, numero } = crearNumeroFactura();
